...
(function (global, factory) {
	...
	*/
	...
	let _document,
	  ...
	  _getComputedStyle$1 = element => _window.getComputedStyle(element),
	  _isArray$1 = Array.isArray,
	  _slice$1 = [].slice,
	  _toArray$1 = (value, leaveStrings) => {
	    let type;
	    return _isArray$1(value) ? value : (type = typeof value) === "string" && !leaveStrings && value ? _slice$1.call(_document.querySelectorAll(value), 0) : value && type === "object" && "length" in value ? _slice$1.call(value, 0) : value ? [value] : [];
	  },
	  ...
	  _deWordify = e => {
	    let children = _toArray$1(e.childNodes),
	      l = children.length,
	      i,
	      child;
	    for (i = 0; i < l; i++) {
	  ...
	  _setPositionsAfterSplit = (element, vars, allChars, allWords, allLines, origWidth, origHeight) => {
	    let cs = _getComputedStyle$1(element),
	  ...
	  _split = (element, vars, wordStart, charStart) => {
	    let children = _toArray$1(element.childNodes),
	      l = children.length,
	      absolute = _isAbsolute(vars),
	      i,
	      child;
	...
	const isBrowser = typeof window !== "undefined" && typeof document !== "undefined" && typeof navigator !== "undefined" && typeof requestAnimationFrame !== "undefined";
	...
	*/
	...
	(function ($) {
	  ...
	  $(window).load(function () {
	    ...
	    function splitType(tar) {
	      const layoutText = new SplitType(tar.find('.split-type__inner'), {
	        types: "words"
	      });
	...
	(function ($) {
	  $(document).ready(function () {
	    $('.peel-btn').each(function () {
	      $(this).append('<i class="fa-sharp fa-solid fa-arrow-right ms-3"></i>');
	    });
	  });
	})(jQuery);
	...
	function getTimeForCity(target, city) {
	  const timezones = {
	    ...
	    // UTC-4
	    London: 1,
	    // UTC+1 (during daylight saving time, otherwise UTC)
	    Singapore: 8 // UTC+8
	  };
